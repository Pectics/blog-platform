...
![Claude Web 语言菜单里的中文入口](/20260404/1.png "菜单里多了一个“简体中文”选项，切进去后页面资源也变成了中文")
...
![dist 白名单产物](/20260404/2.png "最终发布的 dist 目录只包含静态资源，没有扩展源码")
...
![DevTools 中的 Radix submenu DOM 结构](/20260404/3.png "Radix 菜单的结构关系")
...
![错误路线：spa:locale 和假勾选态](/20260404/4.png "只改“spa:locale”或只改菜单勾选态，都不足以触发真正的语言重载")
...
![extension/hook.js 中的核心捕获代码](/20260404/5.png "一次性“Object.assign”劫持的核心代码，命中后立即恢复原始实现")
...
![window.__CLAUDE_I18N_RUNTIME_STATUS__ 的控制台输出](/20260404/6.png "页面运行时状态，显示 i18n store 已被成功捕获，且包含 “setLocaleOverride” 等关键方法")
...
![调用 setLocaleOverride 后页面切成日语的效果](/20260404/7.png '调用“setLocaleOverride("ja-JP")”后，页面无刷新切成日语')
